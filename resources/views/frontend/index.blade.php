                    ...
                    success: function(response) {
                        ...
                        for (let i = 0; i < data.length; i++) {
                            let html = '<div id="oneWayItem'+i+'" class="flight_search_item_wrappper '+data[i]['stopped']+'" data-price="'+data[i]['TotalFare']+'">' +
                                ...
                                '<p>From</p><h3 id="fromCity">'+data[i]['FromCityName']+'</h3><h3 id="fromCity">'+moment(data[i]['DepTime']).format('hh:mmA')+'</h3><h6>'+data[i]['FromAirportCode']+'-'+data[i]['FromAirportName']+'</h6></div></div>' +
                                ...
                                '<div class="flight_search_destination">' +
                                '<p>To</p><h3 id="ToCityName">'+data[i]['ToCityName']+' </h3><h3 id="ToCityName">'+moment(data[i]['ArrTime']).format('hh:mmA')+' </h3><h6>'+data[i]['ToAirportCode']+'-'+data[i]['ToAirportName']+'</h6></div></div></div></div>' +
