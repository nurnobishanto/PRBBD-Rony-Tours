                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.admins.update',['admin'=>$admin->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" value="{{$admin->email}}" type="email" class="form-control" id="email"
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" class="form-control" id="role">
                                ...
                                @foreach($roles as $role)
                                    <option value="{{$role->name}}" @if($admin->hasrole($role->name)) selected @endif>{{$role->name}}</option>
                                @endforeach
                            </select>
                        </div>
