    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.passenger.index')}}">Passenger</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <a href="{{route('admin.passenger.index')}}" class="btn btn-primary" type="submit">Go Back</a>
