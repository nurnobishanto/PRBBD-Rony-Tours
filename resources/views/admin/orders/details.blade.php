                        ...
                        <div class="col-md-4 mb-2">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <th>Booking Time</th>
                                        <td> {{($order->booking_time)?date('d M Y, H:i',strtotime($order->booking_time)):'---'}}</td>
                                    </tr>
                                    <tr>
                                        <th>Booking Expired</th>
                                        <td>{{($order->last_ticket_date)?date('d M Y, H:i',strtotime($order->last_ticket_date)):'---'}}</td>
                                    </tr>
                                    <tr>
                                        <th>Result ID</th>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(!empty($data) && $passenger->pax_index){{$data[0]['TicketNo']}} <a href="{{route('admin.downloadTicket',['id' => $order->id,'ticket' =>$data[0]['TicketNo'] , 'pax_index' => $passenger->pax_index])}}" class="badge  btn-primary"> <i class="fas fa-download"> </i> </a>@endif</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
